...
function Connect() {
    ...
    return (
        ...
        <div className="inner-section border">
            <h1 className="font-weight-bold" style={{fontSize:"30px"}}>Join our community!</h1>
            ...
            <div className="skills" >
                <a className="font-weight-bold" target="blank" href="https://dsc.community.dev/pimpri-chinchwad-college-of-engineering/">Join Us</a>
            </div>
